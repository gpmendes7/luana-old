...
cb:getCausalConnector(1):setSimpleCondition(SimpleCondition:create{role = "onEnd"})
cb:getCausalConnector(1):setCompoundCondition(CompoundCondition:create())
--cb:getCausalConnector(1):setSimpleCondition(SimpleCondition:create{role = "onEnd"})
cb:getCausalConnector(1):setSimpleAction(SimpleAction:create{role = "start"})
local ca = CompoundAction:create()
--ca:addCompoundAction(CompoundAction:create())
--ca:addSimpleAction(SimpleAction:create())
--ca:addSimpleAction(SimpleAction:create{role = "stop"})
--ca:removeCompoundAction(1)
cb:getCausalConnector(1):setCompoundAction(ca)
--head:writeNcl()
