...
local function test6()
   ...
   body = Body:create(atts)
   
   nclExp = "<body"   
   for attribute, value in pairs(body:getAttributes()) do
      nclExp = nclExp.." "..attribute.."=\""..value.."\""
   end 
   
   nclExp = nclExp.."/>\n"

   nclRet = body:table2Ncl(0)
...
local function test7()   
   ...
   local port, property, media, context = nil
   
   local link, switch, meta, metaData = nil
   
   local nclExp, nclRet = nil
   
   body = Body:create{["id"] = "b1"}
   nclExp = "<body id=\"b1\">\n"
